...
void Consumer(int id){
    while (true){
        ...
        thrdQueue.wait_and_pop(someMatrices);
...
int main(){
    ...
    auto elapsedNS = std::chrono::duration_cast<std::chrono::milliseconds>(endTime - startTime);
    std::cout << elapsedNS.count() << " мс" << std::endl;
    return 0;
}